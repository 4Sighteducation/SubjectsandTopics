/**
 * AQA HEBREW (MODERN) A-LEVEL Scraper
 * Code: 7678
...
const SUBJECT = {
  ...
  baseUrl: 'https://www.aqa.org.uk/subjects/hebrew-modern/a-level/hebrew-modern-7672/specification/subject-content'
};

// Standard crawl
async function crawlHebrew() {
  console.log('🔍 Crawling Hebrew (Modern)...');
  try {
