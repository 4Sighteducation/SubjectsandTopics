...
const SUBJECT = {
  ...
  code: '8662',
  qualification: 'GCSE',
  baseUrl: 'https://www.aqa.org.uk/subjects/german/gcse/german-8662/specification/subject-content'
};

async function crawl() {
  console.log('🔍 Crawling GCSE German (full depth)...');
  try {
...
function parseFull(pages) {
  console.log('\n📋 Parsing GCSE German (all levels)...');
  const topics = [];
