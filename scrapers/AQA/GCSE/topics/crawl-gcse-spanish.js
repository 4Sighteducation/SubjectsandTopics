...
const SUBJECT = {
  ...
  code: '8692',
  qualification: 'GCSE',
  baseUrl: 'https://www.aqa.org.uk/subjects/spanish/gcse/spanish-8692/specification/subject-content'
};

async function crawl() {
  console.log('🔍 Crawling GCSE Spanish (full depth)...');
  try {
...
function parseFull(pages) {
  console.log('\n📋 Parsing GCSE Spanish (all levels)...');
  const topics = [];
