"""
GCSE Citizenship Studies - Papers Scraper
Scrapes exam papers for GCSE Citizenship Studies (1CS0)
"""
...
def main():
    """Scrape GCSE Citizenship papers."""
    
    print("=" * 80)
    print("GCSE CITIZENSHIP STUDIES (1CS0) - PAPERS SCRAPER")
    print("=" * 80)
    ...
    try:
        ...
        print("[INFO] Navigating to Citizenship Studies GCSE page...")
        driver.get(url)
        time.sleep(5)
        ...
        for link in pdf_links:
            ...
            # Only process Citizenship papers (1CS0)
            if '1cs0' not in href.lower():
                continue
        ...
        print(f"\n[OK] Found {len(papers)} Citizenship papers")
        ...
        if papers:
            ...
            print("\n" + "=" * 80)
            print("[SUCCESS] GCSE CITIZENSHIP PAPERS UPLOADED!")
            print("=" * 80)
