...
print("=" * 80)
print("GCSE ASTRONOMY - PAPER SCRAPER")
print("=" * 80)
print("Code: 1AS0\n")
...
try:
    ...
    for link in pdf_links:
        ...
        if '1as0' not in href.lower():
            continue
        
        filename = href.split('/')[-1]
        
        # Parse: 1as0-01-que-20220618.pdf
        match = re.search(r'1as0[-_](\d+)[-_]([a-z]{3})[-_](\d{8})', filename, re.IGNORECASE)
    ...
    print(f"\n[INFO] Found {len(papers)} Astronomy papers")
...
print("\n" + "=" * 80)
print("[OK] GCSE ASTRONOMY PAPERS COMPLETE!")
print("=" * 80)
