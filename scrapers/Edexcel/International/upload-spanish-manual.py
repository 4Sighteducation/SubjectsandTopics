"""
Upload Manual Spanish Hierarchy
================================

Uploads the manually created Spanish hierarchy with vocabulary, grammar, and phrases.

Usage:
    python upload-spanish-manual.py
"""
...
SUBJECT_INFO = {
    ...
    'exam_board': 'Edexcel',
    'pdf_url': 'https://qualifications.pearson.com/content/dam/pdf/International%20GCSE/Spanish/2017/specification-and-sample-assessments/international-gcse-spanish-specification.pdf'
}
...
def main():
    print("="*60)
    print("UPLOAD MANUAL SPANISH HIERARCHY")
    print("="*60)
    
    # Parse hierarchy file
    hierarchy_file = Path(__file__).parent / "adobe-ai-output" / "spanish-manual-hierarchy.txt"
    ...
    if success:
        ...
        print("✅ SUCCESS!")
        print("="*60)
        print(f"Uploaded {len(topics)} Spanish topics")
