"""
Edexcel Economics B (9EB0) - Past Papers Scraper (Selenium)
"""
...
print("=" * 80)
print("EDEXCEL ECONOMICS B (9EB0) - PAPERS SCRAPER")
print("=" * 80)
...
try:
    driver.get('https://qualifications.pearson.com/en/qualifications/edexcel-a-levels/economics-b-2015.coursematerials.html#filterQuery=Pearson-UK:Category%2FExam-materials')
    time.sleep(5)
    ...
    for link in pdf_links:
        ...
        if '9eb0' not in href.lower(): continue
        
        filename = href.split('/')[-1]
        match = re.search(r'9eb0[-_](\d+)[-_]([a-z]{3})[-_](\d{8})', filename, re.IGNORECASE)
...
uploaded = upload_papers_to_staging(subject_code='9EB0', qualification_type='A-Level', papers_data=sets, exam_board='Edexcel')
