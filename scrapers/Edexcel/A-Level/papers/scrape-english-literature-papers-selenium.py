"""
Edexcel English Literature (9ET0) - Past Papers Scraper
...
def scrape_english_literature_papers():
    """Scrape English Literature papers using Selenium."""
    ...
    SUBJECT = {
        ...
        'exam_board': 'Edexcel',
        'exam_materials_url': 'https://qualifications.pearson.com/en/qualifications/edexcel-a-levels/english-literature-2015.coursematerials.html#filterQuery=Pearson-UK:Category%2FExam-materials'
    }
    
    print("=" * 80)
    print("EDEXCEL ENGLISH LITERATURE (9ET0) - PAPERS SCRAPER (SELENIUM)")
    print("=" * 80)
    ...
    try:
        ...
        for link in pdf_links:
            ...
            # Only English Literature papers (9et0)
            if '9et0' not in href.lower():
                continue
            
            filename = href.split('/')[-1]
            
            # Parse filename: 9et0-01-que-20240524.pdf
            match = re.search(r'9et0[-_](\d+)[-_]([a-z]{3})[-_](\d{8})', filename, re.IGNORECASE)
...
def main():
    ...
    papers = scrape_english_literature_papers()
    ...
    print("\n" + "=" * 80)
    print("[OK] ENGLISH LITERATURE PAPERS COMPLETE!")
    print("=" * 80)
