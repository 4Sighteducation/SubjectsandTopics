"""
Edexcel Business (9BS0) - Past Papers Scraper
...
def scrape_business_papers():
    """Scrape Business papers using Selenium."""
    ...
    SUBJECT = {
        ...
        'exam_board': 'Edexcel',
        'exam_materials_url': 'https://qualifications.pearson.com/en/qualifications/edexcel-a-levels/business-2015.coursematerials.html#filterQuery=Pearson-UK:Category%2FExam-materials'
    }
    
    print("=" * 80)
    print("EDEXCEL BUSINESS (9BS0) - PAPERS SCRAPER (SELENIUM)")
    print("=" * 80)
    ...
    try:
        ...
        for link in pdf_links:
            ...
            # Only Business papers (9bs0)
            if '9bs0' not in href.lower():
                continue
            
            filename = href.split('/')[-1]
            
            # Parse filename: 9bs0-01-que-20240524.pdf
            match = re.search(r'9bs0[-_](\d+)[-_]([a-z]{3})[-_](\d{8})', filename, re.IGNORECASE)
...
def main():
    ...
    print("\n" + "=" * 80)
    print("[OK] BUSINESS PAPERS COMPLETE!")
    print("=" * 80)
