"""
Edexcel Arabic (9AA0) - Past Papers Scraper
...
def scrape_arabic_papers():
    """Scrape Arabic papers using Selenium."""
    ...
    SUBJECT = {
        ...
        'exam_board': 'Edexcel',
        'exam_materials_url': 'https://qualifications.pearson.com/en/qualifications/edexcel-a-levels/arabic-2018.coursematerials.html#filterQuery=Pearson-UK:Category%2FExam-materials'
    }
    
    print("=" * 80)
    print("EDEXCEL ARABIC (9AA0) - PAPERS SCRAPER (SELENIUM)")
    print("=" * 80)
    ...
    try:
        ...
        for link in pdf_links:
            ...
            # Only Arabic papers (9aa0)
            if '9aa0' not in href.lower():
                continue
            
            filename = href.split('/')[-1]
            
            # Parse filename: 9aa0-01-que-20240524.pdf
            match = re.search(r'9aa0[-_](\d+)[-_]([a-z]{3})[-_](\d{8})', filename, re.IGNORECASE)
...
def main():
    ...
    print("\n" + "=" * 80)
    print("[OK] ARABIC PAPERS COMPLETE!")
    print("=" * 80)
