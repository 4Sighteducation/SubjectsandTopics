"""
Edexcel Art and Design (9AD0) - Past Papers Scraper
...
def scrape_art_papers():
    """Scrape Art and Design papers using Selenium."""
    ...
    SUBJECT = {
        ...
        'exam_board': 'Edexcel',
        'exam_materials_url': 'https://qualifications.pearson.com/en/qualifications/edexcel-a-levels/art-and-design-2015.coursematerials.html#filterQuery=Pearson-UK:Category%2FExam-materials'
    }
    
    print("=" * 80)
    print("EDEXCEL ART AND DESIGN (9AD0) - PAPERS SCRAPER (SELENIUM)")
    print("=" * 80)
    ...
    try:
        ...
        for link in pdf_links:
            ...
            # Only Art and Design papers (9ad0)
            if '9ad0' not in href.lower():
                continue
            
            filename = href.split('/')[-1]
            
            # Parse filename: 9ad0-01-que-20240524.pdf
            match = re.search(r'9ad0[-_](\d+)[-_]([a-z]{3})[-_](\d{8})', filename, re.IGNORECASE)
            ...
            print(f"[OK] {year} {series} - Component {paper_num} - {doc_type}")
...
def main():
    ...
    print("\n" + "=" * 80)
    print("[OK] ART AND DESIGN PAPERS COMPLETE!")
    print("=" * 80)
