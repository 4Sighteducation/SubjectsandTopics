"""
Edexcel Chinese (9CN0) - Past Papers Scraper
...
def scrape_chinese_papers():
    """Scrape Chinese papers using Selenium."""
    ...
    SUBJECT = {
        ...
        'exam_board': 'Edexcel',
        'exam_materials_url': 'https://qualifications.pearson.com/en/qualifications/edexcel-a-levels/chinese-2017.coursematerials.html#filterQuery=Pearson-UK:Category%2FExam-materials'
    }
    
    print("=" * 80)
    print("EDEXCEL CHINESE (9CN0) - PAPERS SCRAPER (SELENIUM)")
    print("=" * 80)
    ...
    try:
        ...
        for link in pdf_links:
            ...
            # Only Chinese papers (9cn0)
            if '9cn0' not in href.lower():
                continue
            
            filename = href.split('/')[-1]
            
            # Parse filename: 9cn0-01-que-20240524.pdf
            match = re.search(r'9cn0[-_](\d+)[-_]([a-z]{3})[-_](\d{8})', filename, re.IGNORECASE)
...
def main():
    ...
    print("\n" + "=" * 80)
    print("[OK] CHINESE PAPERS COMPLETE!")
    print("=" * 80)
