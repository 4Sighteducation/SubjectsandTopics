"""
Edexcel Design and Technology - Product Design (9DT0) - Past Papers Scraper
...
def scrape_design_tech_papers():
    SUBJECT = {
        ...
        'code': '9DT0',
        'exam_materials_url': 'https://qualifications.pearson.com/en/qualifications/edexcel-a-levels/design-and-technology-product-design-2017.coursematerials.html#filterQuery=Pearson-UK:Category%2FExam-materials'
    }
    
    print("=" * 80)
    print("EDEXCEL DESIGN AND TECHNOLOGY (9DT0) - PAPERS SCRAPER (SELENIUM)")
    print("=" * 80)
