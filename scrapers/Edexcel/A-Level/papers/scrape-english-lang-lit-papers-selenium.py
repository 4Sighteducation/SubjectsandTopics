"""
Edexcel English Language and Literature (9EL0) - Past Papers Scraper
...
def scrape_english_lang_lit_papers():
    """Scrape English Language and Literature papers using Selenium."""
    ...
    SUBJECT = {
        ...
        'exam_board': 'Edexcel',
        'exam_materials_url': 'https://qualifications.pearson.com/en/qualifications/edexcel-a-levels/english-language-and-literature-2015.coursematerials.html#filterQuery=Pearson-UK:Category%2FExam-materials'
    }
    
    print("=" * 80)
    print("EDEXCEL ENGLISH LANGUAGE AND LITERATURE (9EL0) - PAPERS SCRAPER (SELENIUM)")
    print("=" * 80)
    ...
    try:
        ...
        for link in pdf_links:
            ...
            # Only English Language and Literature papers (9el0)
            if '9el0' not in href.lower():
                continue
            
            filename = href.split('/')[-1]
            
            # Parse filename: 9el0-01-que-20240524.pdf
            match = re.search(r'9el0[-_](\d+)[-_]([a-z]{3})[-_](\d{8})', filename, re.IGNORECASE)
...
def main():
    ...
    papers = scrape_english_lang_lit_papers()
    ...
    print("\n" + "=" * 80)
    print("[OK] ENGLISH LANGUAGE AND LITERATURE PAPERS COMPLETE!")
    print("=" * 80)
