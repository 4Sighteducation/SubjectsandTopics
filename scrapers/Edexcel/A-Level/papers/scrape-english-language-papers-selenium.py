"""
Edexcel English Language (9EN0) - Past Papers Scraper
...
def scrape_english_language_papers():
    """Scrape English Language papers using Selenium."""
    ...
    SUBJECT = {
        ...
        'exam_board': 'Edexcel',
        'exam_materials_url': 'https://qualifications.pearson.com/en/qualifications/edexcel-a-levels/english-language-2015.coursematerials.html#filterQuery=Pearson-UK:Category%2FExam-materials'
    }
    
    print("=" * 80)
    print("EDEXCEL ENGLISH LANGUAGE (9EN0) - PAPERS SCRAPER (SELENIUM)")
    print("=" * 80)
    ...
    try:
        ...
        for link in pdf_links:
            ...
            # Only English Language papers (9en0)
            if '9en0' not in href.lower():
                continue
            
            filename = href.split('/')[-1]
            
            # Parse filename: 9en0-01-que-20240524.pdf
            match = re.search(r'9en0[-_](\d+)[-_]([a-z]{3})[-_](\d{8})', filename, re.IGNORECASE)
...
def main():
    ...
    papers = scrape_english_language_papers()
    ...
    print("\n" + "=" * 80)
    print("[OK] ENGLISH LANGUAGE PAPERS COMPLETE!")
    print("=" * 80)
