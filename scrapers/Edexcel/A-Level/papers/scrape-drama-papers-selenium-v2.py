...
def scrape_drama_papers():
    ...
    print("=" * 80)
    print("EDEXCEL DRAMA AND THEATRE (9DR0) - PAPERS SCRAPER (ENHANCED)")
    print("=" * 80)
    ...
    try:
        ...
        debug_path = Path(__file__).parent / "debug-drama-page.html"
        ...
        if papers:
            ...
            print("\n[WARN] No papers found - check debug-drama-page.html")
