"""
Edexcel Economics A (9EC0) - Improved Topic Scraper
Same table structure as Business - adapted for Economics

Structure (from specification):
- Level 0: Themes (4 themes)
- Level 1: Sections (e.g., 1.1 Nature of economics)
- Level 2: Content (e.g., 1.1.1 Economics as a social science)
...
SUBJECT = {
    ...
    'exam_board': 'Edexcel',
    'pdf_url': 'https://qualifications.pearson.com/content/dam/pdf/A%20Level/Economics/2015/specification-and-sample-assessment-materials/A_Level_Econ_A_Spec.pdf'
}
...
def download_pdf():
    ...
    try:
        ...
        debug_path = Path(__file__).parent / "debug-economics-a-spec.txt"
...
def parse_economics_topics(text):
    """Parse Economics A topics (same pattern as Business)."""
    print("\n[INFO] Parsing Economics A topics...")
    ...
    themes = [
        {'code': 'Theme1', 'title': 'Theme 1: Introduction to markets and market failure', 'level': 0, 'parent': None},
        {'code': 'Theme2', 'title': 'Theme 2: The UK economy - performance and policies', 'level': 0, 'parent': None},
        {'code': 'Theme3', 'title': 'Theme 3: Business behaviour and the labour market', 'level': 0, 'parent': None},
        {'code': 'Theme4', 'title': 'Theme 4: A global perspective', 'level': 0, 'parent': None}
    ]
    ...
    while i < len(lines):
        ...
        # Pattern 1: Section headers (1.1, 1.2, etc.)
        ...
        # Pattern 2: Content codes (1.1.1, 1.1.2)
        ...
        # Alternative: Content with title on same line
        ...
        # Pattern 3: Learning points (a), b), c))
        ...
        # Pattern 4: Sub-points (o) - Level 4
...
def main():
    ...
    print("=" * 80)
    print("EDEXCEL ECONOMICS A (9EC0) - IMPROVED TOPIC SCRAPER")
    print("=" * 80)
