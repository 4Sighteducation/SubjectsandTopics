...
**Location:** `scrapers/Eduqas/GCSE/topics/`
...
- ✅ **Computer Science** (144 topics, Level 4+ extraction working)
...
### **Test Single Subject**
```bash
cd scrapers/Eduqas/GCSE/topics
...
- [x] Copy `eduqas-gcse-universal-scraper.py` → `eduqas-alevel-universal-scraper.py`
- [x] Update subject loading to filter A-Level subjects
- [x] Update PDF URL patterns for A-Level
- [ ] Test on 1-2 A-Level subjects
- [ ] Verify Level 4+ extraction works
- [x] Create A-Level batch files
