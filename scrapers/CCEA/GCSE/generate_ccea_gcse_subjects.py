"""
Generate expanded CCEA GCSE markdown + JSON from `CCEA - GCSEs.md`.

Outputs:
- scrapers/OCR/GCSE/topics/CCEA - GCSEs - expanded.md
- scrapers/CCEA/GCSE/ccea-gcse-subjects.json
"""
...
from scrapers.CCEA.GCSE.ccea_gcse_subjects import load_subjects_from_repo


SCRAPERS_DIR = Path(__file__).resolve().parents[2]
EXPANDED_MD = SCRAPERS_DIR / "OCR" / "GCSE" / "topics" / "CCEA - GCSEs - expanded.md"
OUT_JSON = Path(__file__).resolve().parent / "ccea-gcse-subjects.json"
